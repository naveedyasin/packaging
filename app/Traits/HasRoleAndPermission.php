...
//        }
    ...
    {
        return (!$this->permissions) ? $this->permissions = $this->rolePermissions()->get()->merge(
...
//        }
    ...
    public function attachPermission($permission)
    {
        ...
        return $this->adminPermissions()->attach($permission);
    }
    ...
    public function detachPermission($permission)
    {
        ...
        return $this->adminPermissions()->detach($permission);
    }
    ...
    public function detachAllPermissions()
    {
        ...
        return $this->adminPermissions()->detach();
    }
    ...
    public function syncPermissions($permissions)
    {
        ...
        return $this->adminPermissions()->sync($permissions);
    }
    ...
    public function callMagic($method, $parameters)
    {
        if (Str::startsWith($method, 'is')) {
            ...
            return $this->allowed(
                ...
                (isset($parameters[2])) ? $parameters[2] : 'admin_id'
            );
        }
