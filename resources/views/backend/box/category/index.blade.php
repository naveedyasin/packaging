@extends('backend.app')
@section('template_title', 'Box Categories')
...
@section('content')
                    ...
                    <div class="card-header header-elements-inline">
                        ...
                        <div class="header-elements">
                            <div class="list-icons">
                                @include('backend.box.category.partials.category-header-buttons')
                            </div>
                        </div>
                    </div>
    ...
    @include('backend.box.category.partials.modal')
@endsection
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            $('#data-table').DataTable({
                ajax: {
                    url: '{{ route("admin.boxcategory.get") }}',
                    type: 'post'
                },
                columns: [
                    {data: 'name', name: 'name'},
