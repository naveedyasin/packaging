@extends('backend.app')
@section('template_title', 'Add Sub Module')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Add Sub Module</h5>
                ...
                <div class="card-body">
                    <form action="{{route('admin.sub-module.store')}}" method="POST" class="form-validate-jquery">
