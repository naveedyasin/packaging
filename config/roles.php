...
return [
    ...
    */
    ...
    'roleUserTable'         => env('ROLES_ROLE_USER_DATABASE_TABLE', 'admins_roles'),
    ...
    'permissionsUserTable'  => env('ROLES_PERMISSION_USER_DATABASE_TABLE', 'admins_permissions'),
    ...
    */
    ...
    | you created. Have a look at `App\Models\Role` model and
    | `App\Models\Permission` model.
    |
    */

    'models' => [
        'role'          => env('ROLES_DEFAULT_ROLE_MODEL', App\Models\Role\Role::class),
        'permission'    => env('ROLES_DEFAULT_PERMISSION_MODEL', App\Models\Permission\Permission::class),
        'defaultUser'   => env('ROLES_DEFAULT_USER_MODEL', App\Models\Admin\Admin::class),
    ],
    ...
    */
    ...
    'bladeExtended'                 => env('ROLES_GUI_BLADE_EXTENDED', 'backend.app'),

    // Blade Extension Placement
    'bladePlacement'                => env('ROLES_GUI_BLADE_PLACEMENT', 'yield'),
    'bladePlacementCss'             => env('ROLES_GUI_BLADE_PLACEMENT_CSS', 'css'),
    'bladePlacementJs'              => env('ROLES_GUI_BLADE_PLACEMENT_JS', 'scripts'),
